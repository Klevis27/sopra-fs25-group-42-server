...
wss.on('connection', (ws, req) => {
  const docName = req.url.slice(1); // e.g. '/markdown-room' -> 'markdown-room'

  setupWSConnection(ws, req, {
    docName,
    gc: true,
    persistenceBindToName: redisPersistence,
  });
});
...
//         const response = await fetch('http://your-java-backend/api/notes', {
